...
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)	// 테스트컨테이너를 이용해야 하기 때문에 내장 테스트 데이터베이스 사용을 비활성화
@ActiveProfiles("integration")	// application-integration.yml 에서 설정을 로드하기 위해 integration 프로파일을 활성화
class BookRepositoryJdbcTests {
    ...
    void findBookByIsbnWhenExisting() {
        ...
        // JdbcAggregateTemplate은 테스트에 필요한 데이터를 준비하는 데 사용
